...
<body>
    <div class="wrap-body">
        ...
        <div class="top">
            <div class="zerogrid">
                <ul class="number f-left">
                    <li class="mail">
                        <p><?php echo $themeOption['email']?></p>
                    </li>
                    <li class="phone">
                        <p><?php echo $themeOption['phone']?></p>
                    </li>
                </ul>
        ...
        <header>
            <div class="zerogrid">
                <a href="<?php echo $themeOption["logo"] ["link"]?>">
                    <center>
                        <div class="logo"><img src="<?php echo $themeOption["logo"]["image"] ?>"
                                alt="<?php echo $themeOption["logo"]["name"]?>"></div>
                    </center>
                </a>
            </div>
        </header>
